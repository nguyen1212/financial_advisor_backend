...
//
//	mockgen -destination=./mock/mock_worker.go -source=worker.go -package=mock
//
...
func (m *MockI) Run(arg0 []byte) error {
	m.ctrl.T.Helper()
...
func (mr *MockIMockRecorder) Run(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockI)(nil).Run), arg0)
}
